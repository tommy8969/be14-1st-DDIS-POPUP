...
2. 회원은 이메일과 비밀번호로 **로그인**할 수 있습니다.
3. 비밀번호를 분실한 경우 본인 인증을 통해 **비밀번호를 재설정**할 수 있습니다.
4. 회원은 자신이 작성한 리뷰와 댓글을 **조회**하고 관리할 수 있습니다.
5. 상품이나 팝업을 **관심 목록에 추가**하거나 조회할 수 있습니다.
6. 결제를 진행하고, 결제 내역을 **확인**할 수 있습니다.
7. 팝업 티켓을 구매한 후 티켓 정보를 **조회**할 수 있습니다.
8. 작성한 리뷰를 **수정하거나 삭제**할 수 있습니다.
